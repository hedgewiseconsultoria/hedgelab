...
vi.mock("./B3CornOptionPremiumMtmGreeksCard", () => ({ default: () => null }));
vi.mock("./B3CattleOptionIntrinsicSettlementCard", () => ({ default: () => null }));
vi.mock("./B3CattleOptionPremiumMtmGreeksCard", () => ({ default: () => null }));
vi.mock("./B3SoyOptionIntrinsicSettlementCard", () => ({ default: () => null }));
vi.mock("./B3SoyOptionPremiumMtmGreeksCard", () => ({ default: () => null }));
vi.mock("./B3SjcOptionIntrinsicSettlementCard", () => ({ default: () => null }));
vi.mock("./B3SjcOptionPremiumMtmGreeksCard", () => ({ default: () => null }));
