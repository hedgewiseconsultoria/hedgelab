...
export default function B3ManualCollectionCard({ onLineage, onNormalizations }: { onLineage?: (rows: B3ManualLineageRow[]) => void; onNormalizations?: (rows: B3NormalizedArtifact[]) => void }) {
