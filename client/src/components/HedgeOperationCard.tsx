...
import { BadgeCheck, ChartNoAxesCombined, CircleAlert, ShieldCheck } from "lucide-react";
...
export default function HedgeOperationCard({ situation, alternative, coveragePct, onCoverageChange, onOpenSimulation, diCurve, compact = false }: Props) {
