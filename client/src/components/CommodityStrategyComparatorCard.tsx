...
export default function CommodityStrategyComparatorCard({ situation, alternative }: { situation: CanonicalEconomicSituationRow; alternative: CanonicalHedgeAlternativeRow }) {
