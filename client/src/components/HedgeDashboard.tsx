...
export default function HedgeDashboard() {
  ...
  const activePanel = dashboardPanelByPath[location] ?? "overview";
  const panelClass = (panel: DashboardPanel) => activePanel === panel ? "" : "hidden";
  ...
  return <section className="mx-auto max-w-[1540px]">
    ...
    <div id="hedge-section-scenarios" className={`scroll-mt-28 ${panelClass("scenarios")}`}><HedgeDiagnosisCard onCanonicalDataframes={receiveCanonicalDiagnosis} />
