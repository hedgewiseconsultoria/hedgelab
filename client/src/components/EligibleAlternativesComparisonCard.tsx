...
import CdiDi1JourneyCard from "@/components/CdiDi1JourneyCard";
...
export default function EligibleAlternativesComparisonCard({ dataframes, lineage = [], selectedAlternativeId, onSelectAlternative, diCurve, onDiCurve, diCurveAsOf = "2026-08-13", onOpenSimulation }: Props) {
  ...
  const showCdiJourney = selectedAlternative?.alternative_kind === "B3_DI1_FUTURE" && selectedSituation?.situation_kind === "CDI_LINKED_DEBT" && Boolean(onDiCurve) && Boolean(onOpenSimulation);
