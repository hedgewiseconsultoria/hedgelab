...
export default function EligibleAlternativesComparisonCard({ dataframes, lineage = [], selectedAlternativeId, onSelectAlternative, diCurve, onDiCurve, diCurveAsOf = "2026-08-13", onOpenSimulation, coveragePct = 100, onCoverageChange = () => {} }: Props) {
