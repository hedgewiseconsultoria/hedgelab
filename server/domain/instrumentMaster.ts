...
export type CommodityFutureSpecification = {
  instrumentKey: "BGI" | "CCM" | "SOY" | "SJC";
  kind: "B3_COMMODITY_FUTURE";
  description: string;
  tradingCode: "BGI" | "CCM" | "SOY" | "SJC";
  contractSize: number;
  contractUnit: "ARROBA" | "SACA_60KG" | "METRIC_TON";
  quotation: "BRL_PER_ARROBA" | "BRL_PER_SACA_60KG" | "USD_PER_METRIC_TON" | "USD_PER_SACA_60KG";
  minimumTick: number;
  standardLotContracts: number;
  maturityRule: string;
  settlement: "FINANCIAL";
...
export const B3_COMMODITY_FUTURE_SPECS: Record<"BGI" | "CCM" | "SOY" | "SJC", CommodityFutureSpecification> = {
