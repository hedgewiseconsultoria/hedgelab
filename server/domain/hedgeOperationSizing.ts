...
function observedQuote(observation: HedgeOperationCatalogObservation | null) {
  ...
  if (observation.instrumentType === "OPTION") return observation.lastPrice ?? observation.tradeAveragePrice ?? observation.adjustedQuoteTax ?? observation.adjustedQuote ?? null;
